...
var initiativeAssignmentName = '${deploymentPrefix}-gov'
...
resource governanceInitiative 'Microsoft.Authorization/policySetDefinitions@2025-01-01' = {
  ...
  properties: {
    ...
    description: 'Minimal Azure Landing Zone governance baseline at management-group scope: allowed locations only. ServiceOwner tag inheritance is assigned separately to resource groups created by this deployment so existing resource groups outside this deployment are not affected.'
    metadata: {
      category: 'Governance'
      version: '2.1.0'
...
resource governanceAssignment 'Microsoft.Authorization/policyAssignments@2025-01-01' = {
  ...
  properties: {
    ...
    description: 'Assigns the Azure Landing Zone governance baseline at management-group scope. Tag inheritance is assigned separately to resource groups created by this deployment.'
