...
.\Deploy-AzureResourceGroup.ps1 -ResourceGroupName "catazr_iam_tx_01" -ResourceGroupLocation "USGov Iowa" -ArtifactStagingDirectory "IAM-WAP" -UploadArtifacts -StorageAccountName "stage9a3c609411534deaa72" -StorageContainerName "iam-wap-stageartifacts"
